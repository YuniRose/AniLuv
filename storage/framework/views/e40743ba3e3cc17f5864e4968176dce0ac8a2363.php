...
<head>
  ...
  <title>Yuni Rose's Resume </title>
...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container" data-aos="zoom-in" data-aos-delay="100">
      <h1>Yuni Rose AD</h1>
      <p>I'm Yuni Rose<span class="typed" data-typed-items="Designer, Developer, Freelancer, Photographer"></span></p>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>About</h2>
          <p>Hi:) Nice to Meet You:) Welcome to My Resume Website.. Let me introduce myself, my name is Yuni Rose Amara Devi.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content">
            <h3>Pelajar &amp; Mahasiswi.</h3>
            <p class="font-italic">
              Saya seorang Mahasiswi di Politeknik Negeri Malang.
            </p>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 1 June 2000</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Website:</strong> www.example.com</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Phone:</strong> 081 33 22 99 xxx</li>
                  <li><i class="icofont-rounded-right"></i> <strong>City:</strong> City : Tulungagung, Jawa Timur Indonesia</li>
                </ul>
              </div>
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Age:</strong> 20</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Degree:</strong> 3rd Semester</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Email:</strong> imyunirose@gmail.com</li>
                  <li><i class="icofont-rounded-right"></i> <strong>Freelance:</strong> Cooming Soon</li>
                </ul>
              </div>
            </div>
            <p>
    ...
    <section id="facts" class="facts">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Facts</h2>
          <p>Saya seorang perempuan yang lahir dari kedua orang tua hebat bernama Hery Kusmanto dan Mujiarti.</p>
        </div>
    ...
    <section id="skills" class="skills section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Skills</h2>
          <p>Skill saya masih sangat dibawah maka dari itu saya sedang dalam tahap mempelajari semua itu.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <div class="resume-item pb-0">
              <h4>Yuni Rose AD</h4>
              <p><em>Cantik dan baik hati serta tidak sombong.</em></p>
              <ul>
                <li>Tulungagung Bersinar</li>
                <li>081 33 22 99 xxx</li>
                <li>imyunirose@gmail.com</li>
              </ul>
            </div>
            ...
            <div class="resume-item">
              <h4>SMA &amp; IPA</h4>
              <h5>2017 - 2019</h5>
              <p><em>SMA Negeri Boyolangu, Tulungagung</em></p>
              <p>SMA Saya</p>
            </div>
            <div class="resume-item">
              <h4>Teknologi Informasi &amp; Manajemen Informatika</h4>
              <h5>2019 - now</h5>
              <p><em>Politeknik Negeri Malang, Malang</em></p>
              <p>Kuliah Saya</p>
            </div>
          </div>
          <div class="col-lg-6">
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Jl Papandayan No. 40 Kauman, Tulungagung</p>
              </div>

              <div class="email">
                <i class="icofont-envelope"></i>
                <h4>Email:</h4>
                <p>imyunirose@gmail.com</p>
              </div>

              <div class="phone">
                <i class="icofont-phone"></i>
                <h4>Call:</h4>
                <p>081 33 22 99 xxx</p>
              </div>
...
</html><?php /**PATH C:\xampp\htdocs\belajar_laravel2\resources\views/tubesYuni.blade.php ENDPATH**/ ?>